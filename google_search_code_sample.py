...
def search_image_on_google(image_url, retry_attempts=3):
    params = {
        "engine": "google_reverse_image",
        "image_url": 'https://photos.zillowstatic.com/fp/48d582e52b4b61b8090b5a0591e41713-cc_ft_768.webp',
        "api_key": SERPAPI_KEY
    }
    ...
    while attempt < retry_attempts:
        try:
            ...
            print(f"Error during search for {image_url}: {e}")
            attempt += 1
